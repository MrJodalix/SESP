...
void input_init(ProgContext* ctx)
{
    ...
    glm_vec3_zero(data->rendering.point_translate);
    data->rendering.point_translate[0] = 30.0;
    data->rendering.point_translate[1] = 0.0;
    data->rendering.point_translate[2] = 0.0;

    glm_vec3_zero(data->rendering.point_scale);
    data->rendering.point_scale[0] = 0.5;
    data->rendering.point_scale[1] = 0.5;
    data->rendering.point_scale[2] = 0.5;

    data->showNormalMap = true;

    data->showRotation = true;
