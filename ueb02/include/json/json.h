/*
   ...
   This version was modified by Nicolas Hollmann to include a 
   SHEREDOM_JSON_IMPLEMENTATION Compiler-Flag so the implementation
...
#ifdef SHEREDOM_JSON_IMPLEMENTATION
