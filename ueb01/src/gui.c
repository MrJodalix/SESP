...
static void gui_widgetLightComp(struct nk_context* nk, const char* name, vec4 col)
{
        ...
        nk_vec2(nk_widget_width(nk), 400)))
    {
        ...
        nk_layout_row_dynamic(nk, 25, 1);
        nkLight.r = nk_propertyf(nk, "#Ambient:", 0, nkLight.r, 1.0f, 0.01f, 0.005f);
        nkLight.g = nk_propertyf(nk, "#Spekular:", 0, nkLight.g, 1.0f, 0.01f, 0.005f);
        nkLight.b = nk_propertyf(nk, "#Diffuse:", 0, nkLight.b, 1.0f, 0.01f, 0.005f);
        nk_combo_end(nk);
    }
