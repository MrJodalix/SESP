...
NK_API void                 nk_glfw3_char_callback(struct nk_glfw* glfw, unsigned int codepoint);
NK_API void                 nk_gflw3_scroll_callback(struct nk_glfw* glfw, double xoff, double yoff);
NK_API void                 nk_glfw3_mouse_button_callback(struct nk_glfw* glfw, GLFWwindow *win, int button, int action, int mods);
...
NK_API void
nk_glfw3_char_callback(struct nk_glfw* glfw, unsigned int codepoint)
{
...
NK_API void
nk_gflw3_scroll_callback(struct nk_glfw* glfw, double xoff, double yoff)
{
...
NK_API void
nk_glfw3_mouse_button_callback(struct nk_glfw* glfw, GLFWwindow* win, int button, int action, int mods)
{
    (void) mods;
    double x, y;
